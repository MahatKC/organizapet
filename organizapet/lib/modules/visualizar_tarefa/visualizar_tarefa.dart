...
class VisualizarTarefa extends StatefulWidget {
  final VisualizarProjetosArguments dados;

  const VisualizarTarefa({required this.dados, Key? key}) : super(key: key);

  @override
  _VisualizarTarefaState createState() => _VisualizarTarefaState();
}

class _VisualizarTarefaState extends State<VisualizarTarefa> {
                  ...
                  return ResponsiveList(
                    list: ListView(children: [
                      ...
                      TitleSubtitleBoxSemIcone(
                          titulo: "Descrição",
                          subtitulo: "ausniasuaihsiahsiahsia asuihai aiushbai ashbaus yausgua"),
                      Padding(
