...
import 'package:organizapet/modules/petianos/lista_petianos.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'A Roberta é pequena'),
    );
  }
}
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              'Quantas vezes a Roberta já ouviu que ela é pequena:',
            ),
            Text(
              '$_counter',
